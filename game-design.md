...
some Cash. Dropped notes or coins spill onto nearby lanes and a portion can be
recovered by steering through them. Tires reduce the amount lost.
...
| 2. Windy open road | Headwind and crosswind | Aerodynamics | Advanced equipment levels |
| 3. Rolling countryside | Repeated short hills | Shifting and endurance | Team branch |
| 4. First categorized climb | Sustained gradient | Power-to-weight ratio | Climbing specializations |
| 5. Mountain pass | Long climb and descent | Nutrition, weight, and braking | Professional equipment tiers |
| 6. Alpe d'Huez | 21 hairpins and a strict cutoff | Complete build optimization | Next campaign |
